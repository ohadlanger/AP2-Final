...
//        Button pictureBtn = findViewById(R.id.pictureBtn);
        ...
        registerBtn.setOnClickListener(view -> {    //  on signup attempt
            ...
            if (!username.isEmpty() && !password.isEmpty() &&
                ...
                MutableLiveData<Integer> created = new MutableLiveData<>(); //  flag to check was signup successful

                created.observe(this, new Observer<Integer>() { //  when we get the result
                    @Override
                    public void onChanged(Integer newValue) {
                        if (newValue == 1) {    //  was created
                ...
                VerifySignup(username, password, verPassword, displayname, base64String, created); //  check information
            }
